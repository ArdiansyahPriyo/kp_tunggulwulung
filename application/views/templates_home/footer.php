    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">Copyright &copy; 2022<a class="ms-25" href="<?php echo base_url() ?>" >K.P Tunggul Wulung</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span>
    </footer>
