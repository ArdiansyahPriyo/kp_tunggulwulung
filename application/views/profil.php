                    ...
                    <!-- profile -->
                        <div class="card">
                            ...
                            <div class="card-body py-2 my-25">
                                ...
                                <div class="d-flex">
                                    <a href="#" class="me-25">
                                        <img src="<?php echo base_url() ?>/assets1/app-assets/images/portrait/small/avatar-s-11.jpg" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                                    </a>
                                    <!-- upload and reset button -->
                                    <div class="d-flex  mt-75 ms-1">
                                        <div>
                                            <span class="h3 d-block"><b><?php echo $this->session->userdata('nama') ?></b></span>
                                ...
                                <form class="validate-form mt-2 pt-50">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="accountFirstName" name="nama"  value="<?php echo $this->session->userdata('nama') ?>" data-msg="Please enter first name" />
                                        </div>
                                        <!-- <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <input type="email" class="form-control" id="accountEmail" name="email" placeholder="Email" value="<?php echo $this->session->userdata('email') ?>" />
                                        </div>
                                        <!-- <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <input type="text" class="form-control account-number-mask" id="accountPhoneNumber" name="phoneNumber"  value="<?php echo $this->session->userdata('no_hp') ?>" />
                                        </div>
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="accountAddress">Alamat</label>
                                            <input type="text" class="form-control" id="accountAddress" name="address" value="<?php echo $this->session->userdata('alamat') ?>" />
                                        </div> 
                                        <!-- <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="accountAddress">Password</label>
                                            <input type="text" class="form-control" id="accountAddress" name="address" value="<?php echo $this->session->userdata('alamat') ?>" />
                                        </div>  -->
                                        <!-- <div class="col-12 col-sm-6 mb-1">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body py-2 my-25">
                                ...
                                <form id="formAccountDeactivation" class="validate-form" onsubmit="return false">
                                    ...
                                    <div>
                                        <button type="submit" class="btn btn-danger deactivate-account mt-1">Nonaktifkan Akun</button>
                                    </div>
                                </form>
                            </div>
                        </div>
